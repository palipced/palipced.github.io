...
public class TreePoint {
    ...
    private String NNAME;//经文htm档书名
    private String filename;//经文htm档文件名
    ...
    public TreePoint(String ID, String NNAME, String filename, String PARENTID, String ISLEAF, int DISPLAY_ORDER) {
        this.ID = ID;
        this.NNAME = NNAME;
