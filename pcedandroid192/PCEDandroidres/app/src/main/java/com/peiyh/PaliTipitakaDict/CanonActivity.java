    ...
    protected void onCreate(Bundle icicle) {
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Cursor palidbcursor = palicanondb.rawQuery("SELECT docid,* FROM canons WHERE PALI like '"+strKeywords+"'",null);
                if (palidbcursor.moveToFirst()){
                    String linkdocid="";
                    String bookname="";
                    String prepali="";
                    ...
                    do{
                        ...
                        if(!(palidbcursor.getString(palidbcursor.getColumnIndex("BOOKID")).equals("0"))) {
                            ...
                            linkdocid = "<a class='cl' href='#docid" + palidbcursor.getString(palidbcursor.getColumnIndex("docid")) + "' onclick='window.openinnewwin.openwin(\"" + palidbcursor.getString(palidbcursor.getColumnIndex("docid")) +  "\")'>click here!</a><br />";
                        }
                        bookname="";
