...
public class MainActivity extends Activity {
			...
			btnLookup.setOnClickListener(new Button.OnClickListener(){
				public void onClick(View v){
	        		...
	        		if (true==palihan_cc(sWord, ""))
	        		{
	        			...
	        			webView.loadDataWithBaseURL("about:blank", "<html><head><style type=\"text/css\">@font-face{font-family:\"\";src:url(\"\");}body{font-family:\"\"; background-color: white;}</style></head><body>" + b.toString() + "</body></html>", "text/html", "utf-8", null);
	        		}else
	        		{
	...
	public boolean onKeyDown(int keyCode, KeyEvent event){
		if(keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0)
		{
			 if(canBack)
			 {
				 webView.loadDataWithBaseURL("about:blank", "<html><head><style type=\"text/css\">@font-face{font-family:\"\";src:url(\"\");}body{font-family:\"\"; background-color: white;}pre{font-family:\"\";}</style></head><body onscroll = \"window.lookup.javaonscroll('"+"javaonscroll"+"')\">" + bufferHtml + "</body></html>", "text/html", "utf-8", null);
				 canBack=false;
	...
	private void listDc()
	{
		...
		for (int z = listFirstNo; z <= listEndNo; z++)
		{
			if(n==101)
			{
				...
				webView.loadDataWithBaseURL("about:blank", "<html><head><style type=\"text/css\">@font-face{font-family:\"\";src:url(\"\");}body{font-family:\"\"; background-color: white;}pre{font-family:\"\";}</style></head><body onscroll = \"window.lookup.javaonscroll('"+"javaonscroll"+"')\">" + b.toString() + "</body></html>", "text/html", "utf-8", null);
